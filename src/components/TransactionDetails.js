          ...
          <Table responsive>
            <tbody>
              <tr>
                <th>Types</th>
                <td>
                  {props?.stateTransactions?.source
                    ? props?.stateTransactions?.source.charAt(0).toUpperCase() +
                      props?.stateTransactions?.source.slice(1)
                    : "Purchase"}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  {formattedNumber(props?.stateTransactions?.price_amount)} Coin
                </td>
              </tr>
              <tr>
                <th>Bonus Token (B)</th>
              ...
              <tr>
                ...
                <td>
                  {formattedNumber(
                    props?.stateTransactions?.token_cryptoAmount
                  )}{" "}
                  Coin
                </td>
              </tr>
              <tr>
                <th>Total Payment</th>
                <td>
                  {formattedNumber(props?.stateTransactions?.price_amount)} {props?.stateTransactions?.price_currency}
                </td>
              </tr>
            </tbody>
          </Table>
        </div>
        {props?.stateTransactions?.status === "rejected" && (
