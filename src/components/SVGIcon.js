...
export const DisabledIcon = ({ width, height }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      id="Layer_1"
      ...
      height={height}
    >
      <path d="m8,12c3.309,0,6-2.691,6-6S11.309,0,8,0,2,2.691,2,6s2.691,6,6,6Zm0-11c2.757,0,5,2.243,5,5s-2.243,5-5,5-5-2.243-5-5S5.243,1,8,1Zm8,21v1.5c0,.276-.224.5-.5.5s-.5-.224-.5-.5v-1.5c0-3.859-3.14-7-7-7s-7,3.141-7,7v1.5c0,.276-.224.5-.5.5s-.5-.224-.5-.5v-1.5c0-4.411,3.589-8,8-8s8,3.589,8,8Zm7.854-6.854c.195.195.195.512,0,.707-.098.098-.226.146-.354.146s-.256-.049-.354-.146l-3.146-3.146-3.146,3.146c-.098.098-.226.146-.354.146s-.256-.049-.354-.146c-.195-.195-.195-.512,0-.707l3.146-3.146-3.146-3.146c-.195-.195-.195-.512,0-.707s.512-.195.707,0l3.146,3.146,3.146-3.146c.195-.195.512-.195.707,0s.195.512,0,.707l-3.146,3.146,3.146,3.146Z" />
    </svg>
  );
};
...
export const CheckBoxIcon = ({ width, height }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        d="M10.0938 5.3125L5.96641 9.25L3.90625 7.28125"
        stroke="white"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M12.625 0.8125H1.375C1.06434 0.8125 0.8125 1.06434 0.8125 1.375V12.625C0.8125 12.9357 1.06434 13.1875 1.375 13.1875H12.625C12.9357 13.1875 13.1875 12.9357 13.1875 12.625V1.375C13.1875 1.06434 12.9357 0.8125 12.625 0.8125Z"
        stroke="white"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const CancelIcon = ({ width, height }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M3.22583 3.22578L12.7743 12.7742"
        stroke="white"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const DownloadIcon = ({ width, height }) => {
  return (
    ...
    >
      <path
        d="M6.04688 8.23438L9 11.1875L11.9531 8.23438"
        stroke="white"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      />
      <path
        d="M15.1875 11.1875V15.125C15.1875 15.2742 15.1282 15.4173 15.0227 15.5227C14.9173 15.6282 14.7742 15.6875 14.625 15.6875H3.375C3.22582 15.6875 3.08274 15.6282 2.97725 15.5227C2.87176 15.4173 2.8125 15.2742 2.8125 15.125V11.1875"
        stroke="white"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
